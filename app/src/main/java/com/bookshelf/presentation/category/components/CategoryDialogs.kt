...
fun ChangeCategoryDialog(
    ...
    if (initialSelection.isEmpty()) {
        AlertDialog(
            onDismissRequest = onDismissRequest,
            confirmButton = {
                com.bookshelf.presentation.core.components.material.TextButton(
                    onClick = {
                        onDismissRequest()
                        onEditCategories()
                    },
    ...
    AlertDialog(
        ...
        confirmButton = {
            Row {
                com.bookshelf.presentation.core.components.material.TextButton(onClick = {
                    onDismissRequest()
                    onEditCategories()
                }) {
                ...
                com.bookshelf.presentation.core.components.material.TextButton(onClick = onDismissRequest) {
                    Text(text = stringResource(MR.strings.action_cancel))
                }
                com.bookshelf.presentation.core.components.material.TextButton(
                    onClick = {
