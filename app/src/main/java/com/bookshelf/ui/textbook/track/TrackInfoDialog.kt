package com.bookshelf.ui.textbook.track
...
import com.bookshelf.domain.track.interactor.DeleteTrack
...
import com.bookshelf.presentation.track.TrackChapterSelector
import com.bookshelf.presentation.track.TrackDateSelector
import com.bookshelf.presentation.track.TrackInfoDialogHome
import com.bookshelf.presentation.track.TrackScoreSelector
import com.bookshelf.presentation.track.TrackStatusSelector
import com.bookshelf.presentation.track.TrackerSearch
...
data class TrackInfoDialogHomeScreen(
    ...
    private val textbookTitle: String,
                ...
                if (it.tracker is EnhancedTracker) {
                    ...
                    navigator.push(
                        TrackerSearchScreen(
                            ...
                            initialQuery = it.track?.title ?: textbookTitle,
    ...
    class Model(
        ...
        interface Factory : ManualViewModelAssistedFactory {
            fun create(textbookId: Long, sourceId: Long): Model
        }
        ...
        init {
            ...
            viewModelScope.launch {
                getTracks.subscribe(textbookId)
        ...
        fun registerEnhancedTracking(item: TrackItem) {
            ...
            viewModelScope.launchNonCancellable {
                val manga = getManga.await(textbookId) ?: return@launchNonCancellable
                try {
                    val matchResult = item.tracker.match(manga) ?: throw Exception()
                    item.tracker.register(matchResult, textbookId)
                } catch (_: Exception) {
                    withUIContext {
...
data class TrackerSearchScreen(
    ...
    class Model(
        ...
        fun registerTracking(item: TrackSearch) {
            viewModelScope.launchNonCancellable { tracker.register(item, textbookId) }
        }
...
data class TrackerRemoveScreen(
    ...
    override fun Content() {
        val navigator = LocalNavigator.currentOrThrow
        val viewModel = assistedMetroViewModel<Model, Model.Factory> {
            create(textbookId = textbookId, track = track, trackerId = serviceId)
        }
    ...
    class Model(
        ...
        @ContributesIntoMap(AppScope::class)
        interface Factory : ManualViewModelAssistedFactory {
            fun create(textbookId: Long, track: Track, trackerId: Long): Model
        }
        ...
        fun unregisterTracking(serviceId: Long) {
            viewModelScope.launchNonCancellable { deleteTrack.await(textbookId, serviceId) }
        }
    }
}
